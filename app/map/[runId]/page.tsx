...
import { Badge, LinkButton, PageHeader, SubHead } from "@/ui/primitives";
...
export default function RunMapPage({ params }: { params: Promise<{ runId: string }> }) {
  ...
  if (!view) return <div className="p-8 text-[13.5px]">業務が見つかりません。</div>;
    ...
    <div className="mx-auto max-w-[1100px] px-6 py-6">
      ...
      {relatedTasks.length > 0 && (
        <section className="mt-8">
          <SubHead title="Spun-off tasks" count={relatedTasks.length} note="この業務から派生したタスク" className="mb-3" />
