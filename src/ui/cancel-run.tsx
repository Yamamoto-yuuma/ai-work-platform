  ...
  return (
    <Card className="mt-4 shadow-pop">
      ...
      <div className="flex flex-col gap-4 p-5">
        ...
        <div>
          <label className="mb-1.5 block text-[13.5px] font-medium" htmlFor="cancel-reason">
            中止する理由<span className="ml-1.5 text-[12px] text-danger">必須</span>
          </label>
          <textarea
            ...
            className="field"
          />
          {error && <p className="mt-1.5 text-[13.5px] text-danger">{error}</p>}
        </div>
        ...
        <dl className="flex flex-col gap-2 text-[13.5px]">
          {reason && (
            <div className="flex gap-3">
              <dt className="w-16 shrink-0 text-[13.5px] text-ink-3">理由</dt>
              <dd className="min-w-0 flex-1">{reason}</dd>
            </div>
          )}
          {event && (
            <div className="flex gap-3">
              <dt className="w-16 shrink-0 text-[13.5px] text-ink-3">中止日時</dt>
